      ...
      <ScrollView style={styles.scroll} showsVerticalScrollIndicator={false}>
        ...
        <View style={[styles.sectionCard, styles.sectionSpacing]}>
          ...
          <View style={styles.sliderGroup}>
            <View style={styles.sliderRow}>
              <View>
                <Text style={styles.sliderLabel}>{t('flashcardSettings.hard')}</Text>
          ...
          <View style={styles.sliderGroup}>
            <View style={styles.sliderRow}>
              <View>
                <Text style={styles.sliderLabel}>{t('flashcardSettings.good')}</Text>
          ...
          <View style={styles.sliderGroup}>
            <View style={styles.sliderRow}>
              <View>
                <Text style={styles.sliderLabel}>{t('flashcardSettings.easy')}</Text>
