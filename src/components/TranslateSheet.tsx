...
export function TranslateSheet({
  ...
  const listLimitLabel = limitReachedLabel ?? t('study.listLimitReached');
          ...
          {loading ? (
            ...
            <>
              ...
              <View style={styles.adContainer}>
                <AdBanner placement="translate_sheet" />
              </View>
            ...
            <View style={styles.pickerOverlay} pointerEvents="box-none">
              ...
              <View style={[styles.pickerCard, showNewListInput && styles.pickerCardWithInput]}>
                ...
                {showNewListInput ? (
                  <View style={styles.newListInput}>
                    <TextInput
                      ...
                      placeholder={maxListsReached ? listLimitLabel : t('translate.listName')}
                      placeholderTextColor={colors.textTertiary}
                      value={newListName}
                      onChangeText={setNewListName}
                      autoFocus={!maxListsReached}
                      editable={!maxListsReached}
                      maxLength={50}
                    />
                    <View style={styles.newListActions}>
                      <TouchableOpacity
                        style={[styles.newListButton, styles.newListButtonCreate, maxListsReached && styles.newListButtonDisabled]}
                        disabled={maxListsReached}
                        onPress={() => {
                          if (!newListName.trim()) {
                ...
                >
                  ...
                  {!showNewListInput ? (
                    <TouchableOpacity
                      style={[styles.pickerRow, styles.newListRow, maxListsReached && styles.pickerRowDisabled]}
                      onPress={() => setShowNewListInput(true)}
                      disabled={maxListsReached}
                    >
                      <Text style={styles.newListText}>
                        {maxListsReached ? listLimitLabel : t('translate.createNewList')}
                      </Text>
                    </TouchableOpacity>
                  ) : null}
                </ScrollView>
