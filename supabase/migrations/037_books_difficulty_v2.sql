...
create index if not exists books_difficulty_score_idx on lingoleaf.books(difficulty_score);
create index if not exists books_difficulty_label_idx on lingoleaf.books(difficulty_label);
create index if not exists books_oov_20k_idx on lingoleaf.books(oov_20k);
