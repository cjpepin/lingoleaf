-- Add status to lingoleaf.user_books: 'reading' (default), 'saved_for_later', or 'completed'
...
BEGIN
  IF NOT EXISTS (
    ...
    WHERE table_schema = 'lingoleaf' AND table_name = 'user_books' AND column_name = 'status'
  ) THEN
